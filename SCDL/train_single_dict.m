function [Dh, Dl] = train_single_dict(Xh, Xl, dict_size, lambda, upscale)
...
% dictionary training
[D] = reg_sparse_coding(Xh, dict_size, [], 0, lambda, 40);
...
dict_path = 'Dictionary_new/test_single_dict.mat';
